...
public class MainActivity extends Activity {
    ...
    // ===== SUA URL O DAY neu server doi dia chi =====
    private static final String APP_URL = "http://10.10.114.65/pv";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setDomStorageEnabled(true);          // can cho sessionStorage (luu key xac thuc)
